...
name: hermetic-club
version: 3.1.0
description: "Hermetic Club integration adapted for claude-code."
---

# Hermetic Club — claude-code variant

This is the claude-code-native adapter for the shared integration contract in
`hermes-skill/SKILL.md`. Use Claude Code file and terminal tools. Inspect before editing, preserve unrelated work, and run the project verification commands before committing.
