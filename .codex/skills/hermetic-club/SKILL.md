...
name: hermetic-club
version: 3.1.0
description: "Hermetic Club integration adapted for codex-cli."
---

# Hermetic Club — codex-cli variant

This is the codex-cli-native adapter for the shared integration contract in
`hermes-skill/SKILL.md`. Use Codex CLI tools: inspect with `rg`/`git`, edit with the normal patch workflow, and run commands from the detected repository root. Delegate review only when explicitly requested; keep credentials out of Codex context.
